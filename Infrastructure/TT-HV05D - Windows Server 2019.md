...
> **Note**
>
> Join the **corp.technologytoolbox.com** domain and rename the computer to **TT-HV05D**.
...
> The protection agent operation failed because DPM detected an unknown DPM protection agent on tt-hv05d.corp.technologytoolbox.com.
>
> Recommended action:\
> Use Add or Remove Programs in Control Panel to uninstall the protection agent from tt-hv05d.corp.technologytoolbox.com, then reinstall the protection agent and perform the operation again.
