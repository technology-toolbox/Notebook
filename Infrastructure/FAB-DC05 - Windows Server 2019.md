...
'FAB-DC05' failed to add device 'Virtual CD/DVD Disk'. (Virtual machine ID 1C5DA42D-5AEC-4BB6-B109-978368DBA25E)
'FAB-DC05': User account does not have permission required to open attachment '\\TT-FS01\Products\Microsoft\Windows Server
2019\en_windows_server_2019_updated_march_2019_x64_dvd_2ae967ab.iso'. Error: 'General access denied error' (0x80070005). (Virtual
machine ID 1C5DA42D-5AEC-4BB6-B109-978368DBA25E)
At line:1 char:1
+ Set-VMDvdDrive `
+ ~~~~~~~~~~~~~~~~
...
```PowerShell
Add-ADGroupMember -Identity "Windows Update - Slot 19" -Members "FAB-DC05$"
```
...
**FAB-DC03 - Run as TECHTOOLBOX\\jjameson-admin**
