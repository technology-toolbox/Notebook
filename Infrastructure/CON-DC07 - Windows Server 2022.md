# CON-DC07 - Windows Server 2022 Domain Controller
...
- On the **Computer Details** step:
  - In the **Computer name** box, type **CON-DC07**.
...
```PowerShell
Add-ADGroupMember -Identity "Windows Update - Slot 17" -Members "CON-DC07$"
```
...
```PowerShell
Get-ADComputer CON-DC05 | Remove-ADObject -Recursive -Confirm:$false
```
...
```PowerShell
Remove-SCVirtualMachine CON-DC05
```
...
Set-WBSchedule -Policy $policy 9:00
...
$trigger = New-ScheduledTaskTrigger -Daily -At '8:55 AM'
...
Add-DnsServerResourceRecordCName `
    ...
    -Name "ntp" `
    -HostNameAlias "CON-DC07.corp.contoso.com"
```
