# EXT-FOOBAR9 - Windows Server 2012 R2 Standard
...
```PowerShell
Remove-NetIPAddress 2601:282:4201:e500::224 -Confirm:$false
```
...
$destPath = "\\EXT-FOOBAR9.extranet.technologytoolbox.com\Z$" `
...
$destPath = "\\EXT-FOOBAR9.extranet.technologytoolbox.com\C$" `
...
$destPath = "\\EXT-FOOBAR9.extranet.technologytoolbox.com" `
    + "\C$\NotBackedUp\Temp"
...
```PowerShell
$certFile = "idp-local-9.technologytoolbox.com.pfx"
...
```PowerShell
$idpHostHeader = "idp-local-9.technologytoolbox.com"
...
$source = ("\\EXT-FOOBAR9.extranet.technologytoolbox.com\C$" `
    + "\NotBackedUp\Temp")
...
```PowerShell
$websiteName = "cloud-local-9.securitasinc.com80"
...
```PowerShell
$websiteName = "cloud2-local-9.securitasinc.com443"
cd "C:\inetpub\wwwroot\wss\VirtualDirectories\$websiteName"
...
$destination = "\\$computerName\C`$\NotBackedUp\Public\Toolbox\cmder"
