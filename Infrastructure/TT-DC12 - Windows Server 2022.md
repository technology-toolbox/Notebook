# TT-DC12 - Windows Server 2022 Domain Controller
...
- On the **Computer Details** step:
  - In the **Computer name** box, type **TT-DC12**.
...
```PowerShell
Add-ADGroupMember -Identity "Windows Update - Slot 2" -Members "TT-DC12$"
```
...
**TT-DC10** - Run as domain administrator
...
```PowerShell
Get-ADComputer TT-DC10 | Remove-ADObject -Recursive -Confirm:$false
```
...
```PowerShell
Remove-SCVirtualMachine TT-DC10
```
...
| ---------------------------------------------------------- | ------------ |
| System Protection\System State (includes Active Directory) | TT-DC12      |
| D:\                                                        | TT-DC12      |
...
#### # Configure DNS record for NTP (ntp.corp.technologytoolbox.com)

```PowerShell
Get-DnsServerResourceRecord -ZoneName corp.technologytoolbox.com -Name ntp |
    Remove-DnsServerResourceRecord -ZoneName corp.technologytoolbox.com -Force

Add-DnsServerResourceRecordCName `
    -ZoneName "corp.technologytoolbox.com" `
    -Name "ntp" `
    -HostNameAlias "TT-DC12.corp.technologytoolbox.com"
```
