...
```PowerShell
$installerPath = '\\TT-FS01\Public\Download\Microsoft\Report Viewer 2008 SP1' `
    + '\ReportViewer.exe'
...
```PowerShell
$setupPath = "\\TT-FS01\Products\Microsoft\System Center 2016\SCOM\Setup.exe"
...
```PowerShell
$setupPath = "\\TT-FS01\Products\Microsoft\System Center 2016\DPM\Redist\vcredist" `
...
```PowerShell
$setupPath = "\\TT-FS01\Products\Microsoft\System Center 2016\DPM\Setup.exe"
...
$setupPath = "\\TT-FS01\Products\Microsoft\System Center 2016\VMM\setup.exe"
